...
"settings":
{
	...
	"uid" : "cee6dea7dfef90e58603ae8d4a357ec8",
	"validation_report" : "in_line"
},
"rules":{"email":{"label":"Email Address","fieldtype":"text","required":true},"password2":{"minlength":5,"label":"Password","fieldtype":"password","required":true},"text3":{"label":"Full Name","fieldtype":"text"},"text4":{"label":"Address","fieldtype":"text"},"select5":{"label":"Select Your Batch","fieldtype":"dropdown","values":["Batch-31","Batch-32","Batch-33","Batch-34"]}},
"payment_rules":{"select5":{}},
"application_version":"Web Form Builder (Windows), build 4652"
}